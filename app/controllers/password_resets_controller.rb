    ...
    def create
        ...
        if @password_reset.valid?
            ...
            if @user && @user.activated?
                ...
                flash.now[ :info ] = "The account with the given address has not been activated. Please #{view_context.link_to( 'activate it', new_account_activation_path, { :class => 'underlined' } )} first.".html_safe
                render( 'new' )
            else
                flash[ :info ] = 'Password reset email has been sent.'
                redirect_to( root_path )
    ...
    private
        ...
        def check_expiration
            if @user.password_reset_expired?
                flash[ :info ] = 'The password reset link has expired. If you still wish to reset your password, please submit your request again.'
